document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      const fieldName = field.getAttribute('data-name') || field.name || field.placeholder || 'This field';
    ...
    contactForm.addEventListener('blur', function(e) {
      ...
      if (field.matches('input, textarea, select') && field.type !== 'hidden' && field.type !== 'submit' && field.type !== 'button') {
        validateField(field);
      }
    }, true);
  ...
  if (animatedElements.length > 0) {
    ...
    // Add CSS for visible state if not already present
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '51d24eee-a042-45bf-8327-cfd4aaef3b82',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '51d24eee-a042-45bf-8327-cfd4aaef3b82';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '51d24eee-a042-45bf-8327-cfd4aaef3b82';
